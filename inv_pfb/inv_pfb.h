...
const uint32_t LOOP_LENGTH = 101 * FFT_SIZE; //Size of chunk to send off to the GPU. This number must be divisable by FFT_SIZE (we should send an integral number of FFTs to the GPU).
