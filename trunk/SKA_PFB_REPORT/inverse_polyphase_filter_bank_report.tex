...
confirm our initial fears about the quality of reconstruction: the basic filter bank construction works well for analysis but does not achieve the desired results in the synthesis.
Although there is a reasonable correlation, which is confirmed by visual inspection of the (time-shifted) output of the synthesis filter bank.
